      ...
      <div className="mx-auto max-w-7xl px-6 lg:flex lg:px-8">
        <div className="mx-auto grid max-w-2xl grid-cols-1 gap-x-12 gap-y-16 lg:mx-0 lg:max-w-none lg:min-w-full lg:flex-none lg:gap-y-8">
          <div className="lg:col-end-1 lg:w-full lg:max-w-lg lg:pb-8">
            ...
            법무법인(유한) 해광은 울산지방법원장을 역임한 구남수 변호사, 서울고등법원 부장판사를 역임한 임성근 변호사, 서울고등법원 고법판사를 역임한 유헌종, 이완희 변호사, 특허법원과 수원고등법원 고법판사를 역임한 김동규 변호사, 서울중앙지방법원 등 경향각지의 부장판사를 역임한 민병훈, 서민석, 함석천, 손병준, 박영호, 박재영, 정연택, 손철, 권순엽 변호사 등 각급 법원 부장판사 출신 변호사 14인과 부산고검장을 역임한 황철규 변호사, 부산지검 차장검사를 역임한 김후균 변호사, 충주지청장을 역임한 최임열 변호사, 대검 중수부 연구관을 역임한 김형욱 변호사 등 각급 검사 출신 변호사 4인을 주축으로 하여 그 외 구성원변호사 5인, 소속변호사 21인으로 구성되었습니다.
            </p>
            <p className="mt-6 text-lg leading-8 text-gray-600">
